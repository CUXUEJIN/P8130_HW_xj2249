...
$$
P(X_{Black}=30) = \frac{\lambda^xe^{- \lambda}}{x!} =  \frac{64.031^{30}e^{64.031}}{30!} = `r dpois(30,0.640)`\approx3.046 \times 10^{-39}
$$
...
\Phi(-1.64+ \frac{1.58}{1.230/\sqrt{10}}) = 0.992
$$

* The posterior power is 0.992, meaning that if there's anything significant, the probability that we can detect it is 99.2%.
